...
/* harmony import */ var next_dist_compiled_react_server_dom_webpack_server_edge__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(8378);
    ...
    const tree = {
        ...
        {
        children: ['', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 7517)), "/Users/carterpatton/Desktop/331/project3-mu/app/employee/page.tsx"],
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 7471)), "/Users/carterpatton/Desktop/331/project3-mu/app/layout.tsx"],
          metadata: {
    icon: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 808))],
    apple: [],
    opengraph: [],
    twitter: [],
  }
    ...
    const pages = ["/Users/carterpatton/Desktop/331/project3-mu/app/employee/page.tsx"];
...
const BlueButton = ({ text  })=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("button", {
        className: "block w-40 py-2 px-4 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline",
        children: text
    });
const ButtonList = ({ numButtons  })=>{
    const buttons = [];
    for(let i = 0; i < numButtons; i++){
        buttons.push(/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(BlueButton, {
            text: `Button ${i + 1}`
        }, i));
    }
...
async function getName() {
    const res = await fetch(`${process.env.BASE_URL}/api/getName`, {
        cache: "no-store"
    });
    if (!res.ok) {
...
function Customer() {
    ...
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
        className: "p-4",
        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(ButtonList, {
            numButtons: 5
        })
    });
}
...
var __webpack_exports__ = __webpack_require__.X(0, [359,385,212], () => (__webpack_exec__(6282)));
